...
const fallbackCatalog: Catalog = {
  Diamond: [
    { number: '07 20 86 88 88', price: '200 DH', status: 'available', tier: 'Diamond' },
    { number: '07 03 34 44 40', price: '200 DH', status: 'available', tier: 'Diamond' },
    ...
    { number: '06 01 11 10 40', price: '200 DH', status: 'available', tier: 'Diamond' },
    { number: '06 99 36 66 62', price: '200 DH', status: 'available', tier: 'Diamond' },
    { number: '07 17 22 22 32', price: '200 DH', status: 'available', tier: 'Diamond' },
    { number: '06 01 60 00 03', price: '200 DH', status: 'available', tier: 'Diamond' },
    { number: '07 22 20 20 01', price: '200 DH', status: 'available', tier: 'Diamond' },
  ],
  Inwi: [
    { number: '07 17 58 88 87', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 24 44 41 97', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 29 01 11 13', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 29 94 44 41', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 04 25 55 57', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 14 44 49 47', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 11 11 93 74', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 13 33 39 88', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 38 78 88 81', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 05 66 61 61', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 07 66 63 69', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 30 33 38 18', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 34 38 33 73', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 00 20 50 12', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 34 34 67 57', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '07 12 11 12 28', price: '150 DH', status: 'available', tier: 'Inwi' },
    { number: '06 00 50 20 38', price: '150 DH', status: 'available', tier: 'Inwi' },
  ],
}
